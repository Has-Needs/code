...
const useLengthContext = () => React.useContext(LengthContext);
const SelectionContext = React.createContext(null);
const useSelectionContext = () => React.useContext(SelectionContext);
const Context = (props) => (jsxRuntime.jsx(LengthContext.Provider, { value: props.length, children: jsxRuntime.jsx(SelectionContext.Provider, { value: props.selection, children: props.children }) }));
...
const Absolute = (props) => (jsxRuntime.jsx("div", { ...props, "aria-hidden": true, style: {
        position: 'absolute',
        left: 0,
        right: 0,
        top: 0,
...
const InputScrollWrapper = (props) => {
    return (jsxRuntime.jsx("div", { ...props, onScroll: handleScroll, style: {
            ...props.style,
            height: '100%',
            overflow: 'hidden',
        } }));
...
const Input = React.forwardRef((props, ref) => {
    ...
    return (jsxRuntime.jsx("input", { ...props, width: undefined, minLength: length, maxLength: length, ref: ref, style: {
            ...props.style,
            font: 'inherit',
...
const CodeInput = ({ renderSegment, length = 6, fontFamily = "'SF Mono', SFMono-Regular, ui-monospace, Menlo, Monaco, 'Cascadia Mono', 'Segoe UI Mono', 'Roboto Mono', monospace", fontSize = '2rem', padding = '0.25rem', paddingY = padding, paddingX = padding, spacing = '0.5rem', characterWidth = '1ch', style, className, inputClassName, inputStyle, segmentWidth = `calc(${characterWidth} + ${paddingX} * 2)`, inputWidth = `calc(100% + ${segmentWidth} + ${spacing})`, inputRef, scrollWrapperClassName, segmentWrapperClassName, rootProps, ...rest }) => {
    const selection = useCodeInput.useCodeInput(inputRef);
    const rootStyle = {
        ...style,
        position: 'relative',
    ...
    return (jsxRuntime.jsx(Context, { length: length, selection: selection, children: jsxRuntime.jsxs("div", { ...rootProps, className: className, style: rootStyle, children: [jsxRuntime.jsx(Absolute, { className: segmentWrapperClassName, children: jsxRuntime.jsx(SegmentRenderer, { children: renderSegment }) }), jsxRuntime.jsx(InputScrollWrapper, { className: scrollWrapperClassName, onMouseDownCapture: (event) => {
                    ...
                    }, children: jsxRuntime.jsx(Input, { width: inputWidth, ...rest, ...inputProps }) })] }) }));
};
