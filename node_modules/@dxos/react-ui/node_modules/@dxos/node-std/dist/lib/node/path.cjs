...
__export(path_exports, {
  ...
  dirname: () => export_dirname,
  extname: () => export_extname,
  format: () => export_format,
  isAbsolute: () => export_isAbsolute,
  join: () => export_join,
  normalize: () => export_normalize,
  parse: () => export_parse,
  relative: () => export_relative,
  resolve: () => export_resolve
});
module.exports = __toCommonJS(path_exports);
var import_chunk_6SZKM6EC = require("./chunk-6SZKM6EC.cjs");
var require_path_browserify = (0, import_chunk_6SZKM6EC.__commonJS)({
...
var path = (0, import_chunk_6SZKM6EC.__toESM)(require_path_browserify(), 1);
var import_path_browserify = (0, import_chunk_6SZKM6EC.__toESM)(require_path_browserify(), 1);
