 ...
 * @deprecated
 */
export declare const getProxySlot: <T extends BaseObject>(proxy: Live<any>) => ProxyHandlerSlot<T>;
export declare const getProxyTarget: <T extends BaseObject>(proxy: Live<any>) => T;
export declare const getProxyHandler: <T extends BaseObject>(proxy: Live<any>) => ReactiveHandler<T>;
/**
 * Unsafe method to override id for debugging/testing and migration purposes.
 * @deprecated
 */
export declare const dangerouslySetProxyId: <T extends BaseObject>(obj: Live<T>, id: string) => void;
/**
 ...
 */
export declare const createProxy: <T extends BaseObject>(target: T, handler: ReactiveHandler<T>) => Live<T>;
/**
 * Passed as the handler to the Proxy constructor.
 * Maintains a mutable slot for the actual handler.
 */
declare class ProxyHandlerSlot<T extends BaseObject> implements ProxyHandler<T> {
    readonly target: T;
    private _handler;
    /**
