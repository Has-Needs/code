...
// packages/common/react-components/src/plugin.ts
var plugin_exports = {};
...
var tailwindConfig = ({ env = "production", root = "./", content = [], extensions = [] }) => ({
  ...
  theme: {
    ...
    extend: (0, import_lodash.default)({
      colors: {
        ...configPalettes,
        slate: import_colors.default.slate,
        gray: import_colors.default.gray,
        zinc: import_colors.default.zinc,
        stone: import_colors.default.stone,
...
// packages/common/react-components/src/plugin.ts
var knownPeerPackages = [
  "@dxos/react-components",
  "@dxos/react-appkit",
  "@dxos/react-ui",
  "@dxos/react-list"
];
var getPackageRootFromResolvedModule = (resolvedPath, packageName) => {
...
var ensureContentHasPeerPackages = (content, rootPath) => {
  const result = [
    ...content
  ];
  knownPeerPackages.forEach((packageName) => {
    ...
    try {
      ...
      result.push((0, import_node_path.resolve)(packageRoot, "dist/**/*.mjs"));
    } catch (e) {
    }
  });
  return result;
