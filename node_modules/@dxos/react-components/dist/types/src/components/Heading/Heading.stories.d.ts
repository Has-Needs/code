...
declare const _default: {
    component: ({ level, ...rootSlot }: import("react").PropsWithChildren<import("./Heading").HeadingProps>) => import("react").DetailedReactHTMLElement<{
        className: string;
...
export declare const Level2: {
    args: {
        level: number;
        children: string;
    };
};
export declare const Level3: {
    args: {
        level: number;
        children: string;
    };
};
export declare const Level4: {
    args: {
        level: number;
        children: string;
    };
};
export declare const Level5: {
    args: {
        level: number;
        children: string;
    };
};
export declare const Level6: {
    args: {
        level: number;
        children: string;
    };
