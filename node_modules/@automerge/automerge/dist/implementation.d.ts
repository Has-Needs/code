import { isImmutableString } from "./proxies.js";
export { isImmutableString } from "./proxies.js";
import { type AutomergeValue, type Cursor, type CursorPosition, type Mark, type MarkSet, type MarkRange, type MarkValue, type MoveCursor, type Doc, type PatchCallback, type Patch } from "./types.js";
export { type AutomergeValue, type Cursor, Counter, type Doc, Int, Uint, Float64, type Mark, type MarkSet, type MarkRange, type MarkValue, type MoveCursor, type Patch, type PatchCallback, type ScalarValue, type PatchInfo, type PatchSource, } from "./types.js";
import type { Automerge, API as WasmAPI, Actor as ActorId, Prop, ObjID, Change, ChangeMetadata, DecodedChange, Heads, MaterializeValue, JsSyncState, SyncMessage, Span, DecodedSyncMessage } from "./wasm_types.js";
export type { ChangeMetadata, PutPatch, DelPatch, SpliceTextPatch, InsertPatch, IncPatch, Span, SyncMessage, } from "./wasm_types.js";
/** @hidden **/
type API = WasmAPI;
declare const _SyncStateSymbol: unique symbol;
/**
...
export declare function getChangesSince<T>(state: Doc<T>, heads: Heads): Change[];
export declare function getChangesMetaSince<T>(state: Doc<T>, heads: Heads): ChangeMetadata[];
/**
 ...
 */
export declare function changeAt<T>(doc: Doc<T>, scope: Heads, options: string | ChangeOptions<T> | ChangeFn<T>, callback?: ChangeFn<T>): ChangeAtResult<T>;
/**
 ...
 *
 */
export declare function saveIncremental<T>(doc: Doc<T>): Uint8Array;
/**
 ...
 */
export declare function diff(doc: Doc<unknown>, before: Heads, after: Heads): Patch[];
/** @hidden */
 ...
 */
export declare function hasOurChanges<T>(doc: Doc<T>, remoteState: SyncState): boolean;
/**
...
export declare function saveSince(doc: Doc<unknown>, heads: Heads): Uint8Array;
/**
 * Returns true if the document has all of the given heads somewhere in its history
 */
export declare function hasHeads(doc: Doc<unknown>, heads: Heads): boolean;
export type { API, SyncState, ActorId, Conflicts, Prop, Change, ObjID, DecodedChange, DecodedSyncMessage, Heads, MaterializeValue, };
/**
 * @hidden
 */
export declare function topoHistoryTraversal(doc: Doc<unknown>): string[];
/**
 ...
 */
export declare function splice<T>(doc: Doc<T>, path: Prop[], index: number | Cursor, del: number, newText?: string): void;
/**
 ...
 * @beta
 */
export declare function updateText(doc: Doc<unknown>, path: Prop[], newText: string): void;
/**
 ...
 */
export declare function spans<T>(doc: Doc<T>, path: Prop[]): Span[];
/**
 * Get the block marker at the given index
 */
export declare function block<T>(doc: Doc<T>, path: Prop[], index: number | Cursor): {
    [key: string]: MaterializeValue;
} | null;
/**
 * Insert a new block marker at the given index
 */
export declare function splitBlock<T>(doc: Doc<T>, path: Prop[], index: number | Cursor, block: {
    [key: string]: MaterializeValue;
}): void;
/**
 * Delete the block marker at the given index
 */
export declare function joinBlock<T>(doc: Doc<T>, path: Prop[], index: number | Cursor): void;
/**
 * Update the block marker at the given index
 */
export declare function updateBlock<T>(doc: Doc<T>, path: Prop[], index: number | Cursor, block: {
    [key: string]: MaterializeValue;
}): void;
/**
 ...
 */
export declare function updateSpans<T>(doc: Doc<T>, path: Prop[], newSpans: Span[]): void;
/**
 ...
 */
export declare function getCursor<T>(doc: Doc<T>, path: Prop[], position: CursorPosition, move?: MoveCursor): Cursor;
/**
 ...
 */
export declare function getCursorPosition<T>(doc: Doc<T>, path: Prop[], cursor: Cursor): number;
export declare function mark<T>(doc: Doc<T>, path: Prop[], range: MarkRange, name: string, value: MarkValue): void;
export declare function unmark<T>(doc: Doc<T>, path: Prop[], range: MarkRange, name: string): void;
export declare function marks<T>(doc: Doc<T>, path: Prop[]): Mark[];
export declare function marksAt<T>(doc: Doc<T>, path: Prop[], index: number): MarkSet;
/**
 * @deprecated This method has been renamed to {@link isImmutableString}
 */
export declare const isRawString: typeof isImmutableString;
/**
 * @deprecated This type has been renamed to {@link ImmutableString}
 */
export declare const RawString: typeof ImmutableString;
