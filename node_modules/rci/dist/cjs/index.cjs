...
var useCodeInput = require('use-code-input');
...
var LengthContext = React__default["default"].createContext(6);
var useLengthContext = function () { return React.useContext(LengthContext); };
var SelectionContext = React__default["default"].createContext(null);
var useSelectionContext = function () { return React.useContext(SelectionContext); };
var Context = function (props) { return (jsxRuntime.jsx(LengthContext.Provider, __assign({ value: props.length }, { children: jsxRuntime.jsx(SelectionContext.Provider, __assign({ value: props.selection }, { children: props.children }), void 0) }), void 0)); };
...
var Root = function (props) { return (jsxRuntime.jsx("div", __assign({}, props, { "data-code-input": 'root' }), void 0)); };
var Absolute = function (props) { return (jsxRuntime.jsx("div", __assign({}, props, { "data-code-input": 'absolute', style: __assign({ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, display: 'flex', justifyContent: 'space-between' }, props.style) }), void 0)); };
...
var InputScrollWrapper = function (props) {
    return (jsxRuntime.jsx("div", __assign({}, props, { "data-code-input": 'input-scroll-wrapper', onScroll: handleScroll, style: __assign(__assign({}, props.style), { height: '100%', overflow: 'hidden' }) }), void 0));
};
...
var CodeInput = function (_a) {
    ...
    var selection = useCodeInput.useCodeInput(inputRef);
    ...
    return (jsxRuntime.jsx(Context, __assign({ length: length, selection: selection }, { children: jsxRuntime.jsxs(Root, __assign({ style: rootStyle, className: className }, { children: [jsxRuntime.jsx(Absolute, __assign({ "aria-hidden": true, style: { zIndex: -1 } }, { children: jsxRuntime.jsx(SegmentRenderer, { children: renderSegment }, void 0) }), void 0), jsxRuntime.jsx(InputScrollWrapper, __assign({ onMouseDownCapture: function (event) {
                        var _a, _b;
                    ...
                    } }, { children: jsxRuntime.jsx(Input, __assign({ width: inputWidth }, rest, inputProps), void 0) }), void 0)] }), void 0) }), void 0));
};
...
Object.defineProperty(exports, 'useCodeInput', {
    enumerable: true,
    get: function () { return useCodeInput.useCodeInput; }
});
exports.CodeInput = CodeInput;
exports.RCI = RCI;
exports.getSegmentCssWidth = getSegmentCssWidth;
exports.useLengthContext = useLengthContext;
