...
export declare namespace TarUtility {
     ...
     */
    const encodeTimestamp: typeof dateTimeToUstar;
    /**
     * @deprecated - use ustarTimeToDate
     */
    const decodeTimestamp: typeof ustarTimeToDate;
    /**
     * @deprecated - use sanitizeDateTimeAsUstar
     */
    const sanitizeTimestamp: typeof sanitizeDateTimeAsUstar;
    /**
     * @deprecated - use getUstarTimestamp
     */
    const getTarTimestamp: typeof getUstarTimestamp;
