...
(function (TarUtility) {
     ...
     */
    TarUtility.encodeTimestamp = dateTimeToUstar;
    /**
     * @deprecated - use ustarTimeToDate
     */
    TarUtility.decodeTimestamp = ustarTimeToDate;
    /**
     * @deprecated - use sanitizeDateTimeAsUstar
     */
    TarUtility.sanitizeTimestamp = sanitizeDateTimeAsUstar;
    /**
     * @deprecated - use getUstarTimestamp
     */
    TarUtility.getTarTimestamp = getUstarTimestamp;
