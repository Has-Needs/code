 ...
 * ```LENGTH KEY=VALUE\n```
 */
export declare class PaxTarHeaderSegment implements TarSerializable {
    private mKey;
    private mValue;
    private mBytes;
    constructor(mKey?: string, mValue?: string, mBytes?: Uint8Array | null);
    static serialize(key: string, value: string): Uint8Array;
    static tryParse(bytes: Uint8Array, offset?: number): PaxTarHeaderSegment | null;
    private static findNextLengthEndIndex;
    get key(): string;
    get value(): string;
