...
var Client = class {
  ...
  */
  async initialize() {
    ...
    const { createClientServices, IFrameManager, ShellManager } = await import("./services-F7CHBVZ3.mjs");
    this._ctx = new Context(void 0, {
      F: __dxlog_file,
      L: 350
    });
  ...
  async _open() {
    ...
    const { SpaceList } = await import("./space-list-2IHEGQYW.mjs");
    const { HaloProxy } = await import("./halo-proxy-YGQE4QY6.mjs");
    const { MeshProxy } = await import("./mesh-proxy-2RN2Z5QB.mjs");
    const { Shell } = await import("./services-F7CHBVZ3.mjs");
...
//# sourceMappingURL=chunk-EW4WDN4K.mjs.map
