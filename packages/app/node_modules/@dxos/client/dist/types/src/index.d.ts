...
export { AlreadyJoinedError, ApiError, CancelledError, DataCorruptionError, DatabaseError, EntityNotFoundError, InvalidConfigError, InvalidInvitationError, InvalidInvitationExtensionRoleError, IdentityNotInitializedError, InvalidStorageVersionError, RemoteServiceConnectionError, RemoteServiceConnectionTimeout, RpcClosedError, RpcNotOpenError, SystemError, UnknownModelError, } from '@dxos/protocols';
export { SystemStatus } from '@dxos/protocols/proto/dxos/client/services';
export { type AppContextRequest, type LayoutRequest, type InvitationUrlRequest, ShellDisplay, ShellLayout, } from '@dxos/protocols/proto/dxos/iframe';
export * from './client';
