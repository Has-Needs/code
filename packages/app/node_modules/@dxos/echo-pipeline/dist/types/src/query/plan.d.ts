...
export declare namespace QueryPlan {
    type TextSearchKind = 'full-text' | 'vector' | 'hybrid';
    /**
    ...
    const Plan: Readonly<{
        make: (steps: Step[]) => Plan;
    }>;
    type Step = ClearWorkingSetStep | SelectStep | FilterStep | FilterDeletedStep | TraverseStep | UnionStep | SetDifferenceStep;
    /**
     * Clear the current working set.
     */
    type ClearWorkingSetStep = {
     ...
     */
    type Selector = WildcardSelector | IdSelector | TypeSelector | TextSelector;
     ...
     */
    type Traversal = ReferenceTraversal | RelationTraversal;
    /**
