...
export declare class IndexVector extends Resource implements Index {
    private _identifier;
    private _extractor;
    ...
    static load({ serialized, identifier }: LoadParams): Promise<IndexVector>;
}
//# sourceMappingURL=index-vector.d.ts.map