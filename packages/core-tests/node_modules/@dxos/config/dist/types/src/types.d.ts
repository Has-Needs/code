...
export declare const FILE_DEFAULTS = "defaults.yml";
export declare const FILE_ENVS = "envs-map.yml";
export declare const FILE_DYNAMICS = "config.yml";
 ...
 */
export type DeepIndex<T, KS extends Keys, Fail = undefined> = KS extends [infer F, ...infer R] ? F extends keyof Exclude<T, undefined> ? R extends Keys ? DeepIndex<Exclude<T, undefined>[F], R, Fail> : Fail : Fail : T;
/**
